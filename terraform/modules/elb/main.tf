...
output "loadbalancer_id" {
  value = huaweicloud_lb_loadbalancer.test.id
}

output "loadbalancer_name" {
  value = huaweicloud_lb_loadbalancer.test.name
}

output "listener_id" {
  value = huaweicloud_lb_listener.test.id
}

output "pool_id" {
  value = huaweicloud_lb_pool.test.id
}
...
output "eip_address" {
  value = var.is_associate_eip ? (var.eip_address != "" ? var.eip_address : huaweicloud_vpc_eip.test[0].address) : null
}
